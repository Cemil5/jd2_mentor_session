...
//        setOfCharacters();
    ...
    static void matchersTest() {
        ...
        System.out.println("colour ? colour|color : " + "colour".matches("colou?r"));  // true
    ...
    static void predefinedCharacterClasses() {
        ...
        System.out.println("1C234yd3eo".replaceAll("\\d", ""));   // Cydeo
        System.out.println("1C234!%&yd3eo".replaceAll("[\\W\\d]", ""));   // Cydeo
        System.out.println("1C234yd3eo".matches("\\d"));   // false
        System.out.println("12343".matches("\\d"));   // false
        System.out.println("12343".matches("\\d+"));   // true

        System.out.println(Arrays.toString("\n   hello   world    Cydeo!   ".split("\\s+")));
        System.out.println(Arrays.toString("   hello   world    Cydeo!   ".split("\\W+")));
        ...
        System.out.println(runTest("\\s", "a   c"));   // 3 finds space
        System.out.println(runTest("\\s+", "a   c"));   // 1 finds the number of the space group
        System.out.println("a   c  "+ runTest("\\s+", "a   c  "));   // 2 finds the number of the space group
