...
public class PlusOneTest {
    ...
    public void withLong_Test(int[] expected, int[] input){
    ...
    @ParameterizedTest
    @MethodSource(value = "inputs")
    public void withBigInteger_Test(int[] expected, int[] input){
    ...
    @ParameterizedTest
    @MethodSource(value = "inputs")
    public void withBigInteger2_Test(int[] expected, int[] input){
       ...
       @ParameterizedTest
    @MethodSource(value = "inputs")
    public void withOneLoop_Test(int[] expected, int[] input){
    ...
    @ParameterizedTest
    @MethodSource(value = "inputs")
    public void withStream_Test(int[] expected, int[] input){
